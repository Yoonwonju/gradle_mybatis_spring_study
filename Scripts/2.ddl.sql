...
addr_id NUMBER NOT NULL, /* 주소코드 */  street VARCHAR2(50) NOT NULL, /* 도로 */  city VARCHAR2(50) NOT NULL, /* 시 */  state VARCHAR2(50) NOT NULL, /* 구 */  zip VARCHAR2(10), /* 우편번호 */  country VARCHAR2(50) NOT NULL /* 읍 */
);
ALTER  TABLE  ADDRESSES  ADD	CONSTRAINT  PK_ADDRESS_ID	PRIMARY KEY (addr_id);

/* 과목 */
CREATE TABLE courses (
course_id NUMBER NOT NULL, /* 과목코드 */  name VARCHAR2(100) NOT NULL, /* 과목명 */  description VARCHAR2(512), /* 설명 */  start_date DATE, /* 시작일 */
end_date DATE, /* 종료일 */
...
stud_id NUMBER NOT NULL, /* 학생코드 */  name VARCHAR2(50) NOT NULL, /* 이름 */  email VARCHAR2(50) NOT NULL, /* 이메일 */  phone NCHAR(13), /* 연락처 */
dob DATE, /* 생일 */  bio CLOB, /* 자기소개 */  pic BLOB, /* 사진 */
addr_id NUMBER /* 주소코드 */
);
...
/* 교수 */
CREATE TABLE tutors (
tutor_id NUMBER NOT NULL, /* 교수번호 */  name VARCHAR2(50) NOT NULL, /* 이름 */  email VARCHAR2(50) NOT NULL, /* 이메일 */  phone NCHAR(13), /* 연락처 */
dob DATE, /* 생일 */
bio CLOB, /* 자기소개 */
pic BLOB, /* 사진 */
addr_id NUMBER /* 주소코드 */
